  ...
  return (
    <Container className='d-flex flex-column align-items-center text-center py-5'>
      ...
      <p className='text-wrapper mt-4'>
        ...
        aviation. Whether you're studying for your PPL or ATPL, we've collected
        questions across various critical subjects, including{' '}
      ...
      <p className='text-wrapper mt-3'>
        Designed by aviation enthusiasts for aspiring pilots, AeroQuiz provides
        a challenging and engaging way to test your knowledge and prepare for
        exams. Ready to take off? Sign up to unlock all quizzes and start your
        journey toward becoming a skilled aviator!
      </p>
